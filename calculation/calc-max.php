...
if( $one > $two  &&  $one > $three){
    echo "max numb is" . $one;
}elseif(  $two > $three &&  $two > $three){
    echo "max numb is" . $two;
}else{
echo "max numb is" . $three;
}
...
<html lang="en">
  ...
  <div class="form-group row">
    <label for="inputPassword3" class="col-sm-2 col-form-label">numer-3</label>
    <div class="col-sm-8">
      <input type="text" name="three" class="form-control"  placeholder="number">
    </div>
  </div>
